...
`endif
	...
	initial begin
		...
		$display("FBREPLAY: clear done; replaying bwidow_frame.txt; draw_buf=%0d", dut.draw_buf);
		fin = $fopen("D:/deck/fpga/blackwidow/Arcade-BlackWidow-SW/sim/bwidow_frame.txt", "r");
		...
		while (!$feof(fin)) begin
			...
			if (r == 4) begin
				...
				@(posedge clk_12);
				if (fxs >= 0 && fxs < 960 && fys >= 0 && fys < 720) begin
